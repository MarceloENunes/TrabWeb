...
public class ContentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                    <div class=\"row\">\n"
                        + "                        <div class=\"col-md-12\">\n"
                        + "                            <h1>" + request.getSession().getAttribute("username") + " - Fazer Upload</h1></div>\n"
                        + "                        <div class=\"col-md-12\">\n"
                        + "                            <div class=\"col-md-6\" style=\"padding:0px;\">\n"
                        + "                                <div class=\"jumbotron jumbotron-account\">\n"
                        + "                                   <form action=\"./ContentServlet\" method=\"post\" accept-charset=\"utf-8\">\n"
                        + "                                     <input type=\"text\" name=\"texto\" size=\"100\" />\n"
                        + "                                    <input type=\"submit\" value=\"Upload\" class=\"btn btn-default btn-green btn-green-account\" role=\"button\"/>\n"
                        + "                                   </form>"
                        + "                                </div>\n"
                        + "                        </div>\n"
                        + "                    </div>\n"
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        conteudo.setLogin(request.getSession().getAttribute("username").toString());
        conteudo.setTexto(request.getParameter("texto"));
        
        try{
            ContentDAO contentDAO = new ContentDAO();
            contentDAO.addContent(conteudo);
